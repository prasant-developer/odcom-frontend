                ...
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="h-1 w-1 rounded-full bg-[#D3C4FC]" />
                      <span className="text-[8.5px] font-bold uppercase tracking-[0.1em] text-[#8B7BB5]">
                        Rental Control
                      </span>
                    </div>
              ...
              <div className="px-4 py-3 sm:px-5">
                ...
                <div className="mt-2.5 flex flex-col gap-2 border-t border-[#F3EFFF] pt-2 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="inline-flex rounded-lg border border-[#E3D9FF] bg-[#FAF8FF] p-0.5">
                      <button
                        type="button"
                        onClick={() => {
                          setDateFilterMode("single");
                        ...
                        className={`h-6 rounded-md px-2 text-[8.5px] font-extrabold transition ${
                          dateFilterMode === "single"
                            ? "bg-white text-[#5d2ed7] shadow-sm ring-1 ring-[#E3D9FF]"
                            : "text-[#7F6EA6] hover:text-[#553E82]"
                        }`}
