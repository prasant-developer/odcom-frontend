...
export default function App() {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span className="inline-flex items-center gap-2 rounded-full border border-[#E3D9FF] bg-[#F3EFFF] px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-[0.08em] text-[#5d2ed7]">
        <span className="relative flex h-1.5 w-1.5">
          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#D3C4FC] opacity-75"></span>
          <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-[#5d2ed7]"></span>
        </span>
        Active
      </span>
    );
  ...
  const inputClass =
    "w-full rounded-[14px] border border-[#E3D9FF] bg-[#FAF8FF] px-4 py-3 text-sm font-semibold text-[#22124D] placeholder:font-medium placeholder:text-[#A697C7] outline-none transition-all duration-200 hover:border-[#D3C4FC] focus:border-[#5d2ed7] focus:bg-white focus:ring-4 focus:ring-[#5d2ed7]/[0.08]";
  const labelClass =
    "mb-2 block text-[10px] font-extrabold uppercase tracking-[0.11em] text-[#7F6EA6]";
    ...
    <DashboardLayout>
      <div className="mx-auto w-full max-w-[1450px] space-y-6">
        ...
        <section className="relative overflow-hidden rounded-[24px] border border-[#E3D9FF] bg-white shadow-[0_12px_35px_rgba(93,46,215,0.06)]">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -right-16 -top-24 h-64 w-64 rounded-full bg-[#5d2ed7]/[0.06] blur-3xl" />
            <div className="absolute -bottom-20 left-[28%] h-44 w-44 rounded-full bg-[#421E9F]/[0.035] blur-3xl" />
          </div>

          <div className="relative px-5 py-5 sm:px-6 lg:px-7">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-start gap-4">
                <div className="hidden h-12 w-12 shrink-0 items-center justify-center rounded-[15px] bg-gradient-to-br from-[#421E9F] to-[#5d2ed7] text-white shadow-[0_10px_24px_rgba(93,46,215,0.22)] sm:flex">
                  <Database size={22} strokeWidth={2.1} />
                </div>

                <div>
                  <h1 className="text-[22px] font-extrabold tracking-[-0.025em] text-[#22124D] sm:text-[26px]">
                    Equipment & Support Master
                  </h1>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <div className="flex items-center gap-2 rounded-[12px] border border-[#E3D9FF] bg-[#F3EFFF] px-3.5 py-2.5">
                  <span className="relative flex h-2 w-2">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.06em] text-[#553E82]">
                    Active
                  </span>
                  <span className="text-sm font-extrabold text-[#5d2ed7]">
                    {availableCount}
                  </span>
                </div>
                ...
                <button
                  onClick={() => handleOpenModal()}
                  className="group ml-auto inline-flex min-h-[42px] items-center gap-2 rounded-[13px] bg-gradient-to-r from-[#421E9F] to-[#5d2ed7] px-4 py-2.5 text-[12px] font-extrabold text-white shadow-[0_9px_22px_rgba(93,46,215,0.2)] transition-all duration-200 hover:-translate-y-[1px] hover:shadow-[0_12px_28px_rgba(93,46,215,0.26)] active:translate-y-0 sm:ml-0"
                >
                  <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-white/12">
                    <Plus size={15} strokeWidth={2.5} />
                  </span>
          ...
          {/* ===== PREMIUM MODULE TABS ===== */}
          <div className="relative border-t border-[#F3EFFF] bg-[#FAF8FF] px-4 py-2.5 sm:px-6">
            <div className="flex gap-1.5 overflow-x-auto scrollbar-none">
              {TABS.map((tab) => {
                const TabIcon = tab.icon;
                const selected = activeTab === tab.id;
                ...
                return (
                  <button
                    ...
                    className={`group flex shrink-0 items-center gap-2 rounded-[12px] px-3.5 py-2.5 text-[11px] font-bold transition-all duration-200 ${
                      selected
                        ? "bg-white text-[#5d2ed7] shadow-[0_4px_14px_rgba(93,46,215,0.08)] ring-1 ring-[#E3D9FF]"
                        : "text-[#7F6EA6] hover:bg-white/70 hover:text-[#553E82]"
                    }`}
                  >
                    <span
                      className={`flex h-7 w-7 items-center justify-center rounded-[9px] transition-colors ${
                        selected
                          ? "bg-[#F3EFFF] text-[#5d2ed7]"
                          : "bg-[#F1ECFD] text-[#9C8AC7] group-hover:text-[#5d2ed7]"
                      }`}
                    >
                      <TabIcon size={14} strokeWidth={2} />
                    </span>
                    {tab.label}
                    {selected && (
                      <span className="h-1.5 w-1.5 rounded-full bg-[#5d2ed7]" />
                    )}
                  </button>
                );
              })}
        ...
        {/* ===== PREMIUM TABLE CARD ===== */}
        <section className="overflow-hidden rounded-[22px] border border-[#E3D9FF] bg-white shadow-[0_10px_30px_rgba(93,46,215,0.055)]">
          <div className="flex flex-col gap-3 border-b border-[#F3EFFF] bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-[11px] border border-[#E3D9FF] bg-[#FAF8FF] text-[#5d2ed7]">
                <ActiveTabIcon size={17} strokeWidth={2} />
              </div>

              <div>
                <p className="text-[11px] font-extrabold text-[#22124D]">
                  {TABS.find((t) => t.id === activeTab)?.label}
                </p>
                <p className="mt-0.5 text-[9.5px] font-medium text-[#7F6EA6]">
                  {assets.length} total record{assets.length === 1 ? "" : "s"}
                </p>
              </div>
            </div>
            ...
            <button
              onClick={fetchAssets}
              disabled={isLoading}
              className="inline-flex items-center gap-2 self-start rounded-[10px] border border-[#E3D9FF] bg-[#FAF8FF] px-3 py-2 text-[10px] font-bold text-[#553E82] transition hover:border-[#D3C4FC] hover:bg-[#F3EFFF] hover:text-[#5d2ed7] disabled:opacity-40 sm:self-auto"
            >
              <RefreshCw
                size={13}
                className={isLoading ? "animate-spin" : ""}
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[700px] border-collapse text-left">
              <thead>
                <tr className="border-b border-[#F3EFFF] bg-[#FAF8FF] text-[9.5px] font-extrabold uppercase tracking-[0.12em] text-[#7F6EA6]">
                  {activeTab === "device" && (
                    <>
                      <th className="w-24 px-6 py-3.5">ID</th>
                      <th className="px-6 py-3.5">Device Name</th>
              ...
              <tbody className="divide-y divide-[#F3EFFF]">
                {isLoading ? (
                  <tr>
                    <td colSpan={6} className="py-24 text-center">
                      <div className="inline-flex flex-col items-center gap-3">
                        <div className="h-9 w-9 rounded-full border-[3px] border-[#E8DEFF] border-t-[#5d2ed7] animate-spin" />
                        <div>
                          <p className="text-[12px] font-bold text-[#553E82]">
                            Loading master records
                          </p>
                          <p className="mt-1 text-[10px] font-medium text-[#A697C7]">
                            Syncing operational data…
                          </p>
                        </div>
                      </div>
                  ...
                  <tr>
                    <td colSpan={6} className="py-24 text-center">
                      <div className="mx-auto flex max-w-xs flex-col items-center">
                        <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-[15px] border border-[#E3D9FF] bg-[#FAF8FF] text-[#9C8AC7]">
                          <Database size={21} />
                        </div>
                        <p className="text-[13px] font-extrabold text-[#22124D]">
                          No records available
                        </p>
                        <p className="mt-1 text-[10.5px] leading-5 text-[#7F6EA6]">
                          Create the first {TABS.find((t) => t.id === activeTab)?.label?.toLowerCase()} record to begin.
                        </p>
                        <button
                          onClick={() => handleOpenModal()}
                          className="mt-4 inline-flex items-center gap-1.5 rounded-[10px] bg-[#F3EFFF] px-3 py-2 text-[10px] font-extrabold text-[#5d2ed7] transition hover:bg-[#EAE2FF]"
                        >
                          <Plus size={13} />
                          Create first entry
                        </button>
                  ...
                  assets.map((item, index) => {
                    ...
                    return (
                      <tr
                        key={idValue ?? `row-${index}`}
                        className="group transition-colors duration-150 hover:bg-[#FAF8FF]"
                      >
                        {activeTab === "device" && (
                          <>
                            <td className="px-6 py-4">
                              <span className="rounded-[7px] border border-[#E3D9FF] bg-[#FAF8FF] px-2 py-1 font-mono text-[10px] font-bold text-[#7F6EA6]">
                                #{item.device_id}
                              </span>
                            </td>
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-3">
                                <span className="flex h-8 w-8 items-center justify-center rounded-[10px] bg-[#F3EFFF] text-[#5d2ed7]">
                                  <MonitorCog size={15} />
                                </span>
                                <span className="text-[12.5px] font-bold text-[#22124D]">
                                  {item.device_name}
                                </span>
                              </div>
                            </td>
                              ...
                              <div className="flex flex-wrap gap-1.5">
                                {Array.isArray(item.accessories) && item.accessories.length > 0 ? (
                                  item.accessories.map((acc, i) => (
                                    <span
                                      key={i}
                                      className="inline-flex rounded-full border border-[#E8DEFF] bg-[#F3EFFF] px-2.5 py-0.5 text-[10px] font-semibold text-[#5d2ed7]"
                                    >
                                      {typeof acc === "string" ? acc : acc?.accessory_name || "—"}
                                    </span>
                                  ))
                                ) : (
                                  <span className="text-[11px] text-[#A697C7]">No accessories</span>
                                )}
                              </div>
                            </td>
                            <td className="px-6 py-4">
                        ...
                        {activeTab === "care" && (
                          <>
                            ...
                            <td className="max-w-[230px] px-6 py-4 text-[11.5px] font-medium text-[#553E82]">
                              <span className="line-clamp-2">{item.address || "—"}</span>
                            </td>
                            <td className="px-6 py-4">
                              <div className="space-y-0.5 font-mono text-[10.5px] font-semibold text-[#553E82]">
                                <div>{item.mobile_number || "—"}</div>
                                {item.alternative_mobile_number && (
                                  <div className="text-[#A697C7]">
                                    {item.alternative_mobile_number}
                                  </div>
                                )}
                              </div>
                        ...
                        {activeTab === "reference" && (
                          <>
                            <td className="px-6 py-4">
                              <div className="flex items-start gap-3">
                                <span className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-[10px] bg-[#FAF8FF] text-[#5d2ed7]">
                                  <UserRound size={15} />
                                </span>
                                <div>
                                  <p className="text-[12.5px] font-bold text-[#22124D]">
                                    {item.doctor_name}
                                  </p>
                                  <p className="mt-0.5 text-[10px] font-medium text-[#7F6EA6]">
                                    {item.specialist || "—"}
                                  </p>
                                </div>
                              </div>
                            </td>
                            <td className="px-6 py-4 text-[11.5px] font-semibold text-[#553E82]">
                              {item.hospital_name || "—"}
                            </td>
                            <td className="px-6 py-4">
                              <div className="space-y-0.5 font-mono text-[10.5px] font-semibold text-[#553E82]">
                        ...
                        {activeTab === "delivery" && (
                          <>
                            ...
                            <td className="px-6 py-4 font-mono text-[10.5px] font-semibold text-[#553E82]">
                              {item.mobile_number || "—"}
                            </td>
                            <td className="px-6 py-4">
                              {getStatusBadge(item.status)}
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="inline-flex items-center gap-1.5">
                            <button
                              type="button"
                              onClick={() => handleOpenModal(item)}
                              className="group/edit relative flex h-8 w-8 items-center justify-center rounded-[9px] border border-[#E3D9FF] bg-[#FAF8FF] text-[#5d2ed7] transition-all hover:border-[#D3C4FC] hover:bg-[#F3EFFF] hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-[#5d2ed7]/20"
                              title="Edit record"
                              aria-label="Edit record"
                            >
                              <Edit3 size={14} strokeWidth={2.1} />
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div
            className="absolute inset-0 bg-[#22124D]/55 backdrop-blur-[4px]"
            onClick={handleCloseModal}
          />

          <div className="relative max-h-[92vh] w-full max-w-lg overflow-hidden rounded-[24px] border border-white/50 bg-white shadow-[0_30px_90px_rgba(37,15,97,0.28)] animate-in fade-in zoom-in-95 duration-150">
            <div className="relative overflow-hidden bg-gradient-to-r from-[#250F61] via-[#421E9F] to-[#5d2ed7] px-6 py-5">
              <div className="pointer-events-none absolute -right-12 -top-14 h-40 w-40 rounded-full border border-white/10" />
              <div className="pointer-events-none absolute right-7 top-3 h-24 w-24 rounded-full border border-white/5" />
            ...
            >
              ...
              {activeTab === "device" && (
                <>
                  ...
                  <div className="rounded-[16px] border border-[#E3D9FF] bg-[#FAF8FF] p-4">
                    <div className="mb-3 flex items-center justify-between gap-3">
                      <div>
                        <label className={labelClass}>Accessories</label>
                        <p className="text-[10px] text-[#7F6EA6]">
                          Optional – leave empty if none
                        </p>
                      </div>
                      ...
                      <button
                        type="button"
                        onClick={addAccessoryRow}
                        className="inline-flex h-9 shrink-0 items-center gap-1.5 rounded-[10px] bg-[#5d2ed7] px-3 py-2 text-[10px] font-extrabold text-white shadow-sm transition hover:bg-[#421E9F]"
                        title="Add accessory"
                        aria-label="Add accessory"
                      >
                        <Plus size={14} strokeWidth={2.5} />
                    ...
                    <div className="space-y-2.5">
                      {(deviceForm.accessories || []).map((accessory, index) => (
                        <div
                          key={`accessory-row-${index}`}
                          className="flex items-end gap-2 rounded-[12px] border border-[#E8DEFF] bg-white p-2.5"
                        >
                          <div className="min-w-0 flex-1">
                            <label className={labelClass}>
                              Accessory {index + 1}
              ...
              <div className="flex items-center justify-end gap-2.5 border-t border-[#F3EFFF] pt-4">
                <button
                  type="button"
                  onClick={handleCloseModal}
                  disabled={isSubmitting}
                  className="rounded-[11px] border border-[#E3D9FF] bg-white px-4 py-2.5 text-[11px] font-bold text-[#553E82] transition hover:bg-[#FAF8FF] disabled:opacity-50"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="inline-flex min-w-[124px] items-center justify-center gap-2 rounded-[11px] bg-gradient-to-r from-[#421E9F] to-[#5d2ed7] px-5 py-2.5 text-[11px] font-extrabold text-white shadow-[0_8px_20px_rgba(93,46,215,0.2)] transition hover:-translate-y-[1px] hover:shadow-[0_11px_24px_rgba(93,46,215,0.25)] disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {isSubmitting ? (
                    <>
                      <span className="h-4 w-4 animate-spin rounded-full border-2 border-white/30 border-t-white" />
