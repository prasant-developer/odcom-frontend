...
//   device_name: "",
//   status: "active",
//   accessories: [{ accessory_id: "", accessory_name: "", status: "active" }],
// };
...
//       accessories: [
//         ...(prev.accessories || []),
//         { accessory_id: "", accessory_name: "", status: "active" },
//       ],
//     }));
//   };

//   const updateAccessoryRow = (index, field, value) => {
//     setDeviceForm((prev) => ({
//       ...prev,
//       accessories: (prev.accessories || []).map((accessory, rowIndex) =>
//         rowIndex === index ? { ...accessory, [field]: value } : accessory
//       ),
//     }));
//   };
...
//     // A device can contain multiple accessories.
//     // Empty accessory rows are not submitted.
//     if (activeTab === "device") {
//       bodyPayload.accessories = (currentForm.accessories || [])
//         .filter((accessory) => String(accessory.accessory_name || "").trim())
//         .map((accessory) => ({
//           ...(accessory.accessory_id ? { accessory_id: accessory.accessory_id } : {}),
//           accessory_name: String(accessory.accessory_name || "").trim(),
...
//                         <div
//                           key={accessory.accessory_id || `accessory-row-${index}`}
