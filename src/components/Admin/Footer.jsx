...
const Footer = () => {
  return (
    <footer className="relative h-[58px] bg-white/95 backdrop-blur-md border-t border-[#E4DCFF] flex items-center justify-between px-8 text-xs font-medium text-[#8B7BB5] overflow-hidden">
      {/* Subtle background glow */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -bottom-10 left-[18%] w-44 h-20 rounded-full bg-[#673de6]/[0.04] blur-2xl" />
        <div className="absolute -top-12 right-[10%] w-40 h-20 rounded-full bg-[#4A1FB8]/[0.03] blur-2xl" />
      </div>
      ...
      <div className="relative z-10 flex items-center gap-4">
        {/* System icon */}
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-[10px] bg-[#F3EEFF] border border-[#E9E2FF] flex items-center justify-center text-[#673de6]">
            <Cpu size={15} strokeWidth={2} />
          </div>

          <div className="leading-tight">
            <div className="flex items-center gap-2">
              <span className="text-[10.5px] font-bold text-[#2E1A5E]">
                Core Platform
              </span>

              <span className="inline-flex items-center gap-1 rounded-full bg-[#F3EEFF] border border-[#E4DCFF] px-2 py-[2px] text-[8px] font-extrabold uppercase tracking-[0.08em] text-[#673de6]">
                <span className="w-1.5 h-1.5 rounded-full bg-[#673de6]" />
                Stable
              </span>
            </div>

            <p className="mt-0.5 text-[9px] font-medium text-[#8B7BB5]">
              Equipment Operations & Support · v4.8.2
            </p>
          </div>
        </div>
        ...
        {/* Divider */}
        <div className="hidden lg:block w-px h-7 bg-[#E4DCFF]" />

        {/* Platform status */}
        <div className="hidden lg:flex items-center gap-2 text-[9.5px] font-semibold text-[#5C4B7A]">
          <Activity
            size={13}
            strokeWidth={2}
        ...
        {/* Server status */}
        <div className="hidden xl:flex items-center gap-2 text-[9.5px] font-semibold text-[#5C4B7A]">
          <Server
            size={13}
            strokeWidth={2}
            className="text-[#5B2BD4]"
          />
      ...
      <div className="relative z-10 flex items-center gap-5">
        {/* Secure system */}
        <div className="hidden md:flex items-center gap-2 rounded-lg bg-[#FCFAFF] border border-[#E4DCFF] px-2.5 py-1.5">
          <ShieldCheck
            size={13}
            strokeWidth={2}
            className="text-[#673de6]"
          ...
          <span className="text-[9px] font-bold uppercase tracking-[0.07em] text-[#5C4B7A]">
            Secure System
          </span>
        </div>
      </div>
